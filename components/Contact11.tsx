...
export default function Contact11() {
  ...
  return (
    <section id="contact" className="relative section-padding bg-linear-to-b from-beige-50/50 to-cream">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12">
          <a href="mailto:khawla@englishwithkhawla.com" className="btn-secondary">
