...
const courseKeys = [
  {
    titleKey: 'courses.oneToOne.title',
  ...
  {
    titleKey: 'courses.soutienScolaire.title',
    descKey:  'courses.soutienScolaire.desc',
    levelKey: 'courses.allLevels',
    duration: '12', lessons: 24,
    thumbnail: '/SchoolSupport.jpeg',
    color: 'from-emerald-400 to-teal-500',
    badge: 'bg-emerald-50 border-emerald-200 text-emerald-700',
  },
  {
    titleKey: 'courses.discussion.title',
    descKey:  'courses.discussion.desc',
    levelKey: 'courses.levelDiscussion',
    duration: '6', lessons: 12,
    thumbnail: '/Conversation.jpeg',
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {courseKeys.map((course, i) => (
            <div
              key={course.titleKey}
              className="group bg-white/70 backdrop-blur-sm border border-[#C4B5FD]/25 rounded-3xl overflow-hidden hover:border-[#C4B5FD]/60 hover:shadow-xl hover:shadow-purple-100/50 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col"
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-1 gap-3">
                <h3 className="text-base font-bold text-[#1a1a2e] group-hover:text-[#7C3AED] transition-colors leading-snug">
                  {t(course.titleKey)}
                </h3>
                ...
                {/* Meta + CTA — collé en bas */}
                <div className="flex items-center justify-between pt-3 border-t border-[#C4B5FD]/20 mt-auto">
                  ...
                  <a
                    href="#register"
                    className={`flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-bold text-white bg-linear-to-r ${course.color} hover:scale-105 active:scale-95 transition-transform shadow-sm`}
                  >
