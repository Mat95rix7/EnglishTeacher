...
// import { Star, ChevronLeft, ChevronRight, Quote, PlusCircle, X } from 'lucide-react';
// import { useI18n } from '../lib/i18n';
// import { useReviews, type SubmitFields } from '@/hooks/useReviews';
...
//    → utilisées si Firestore est vide ou en erreur
// ───────────────────────────────────────────── */
// const INITIAL_REVIEWS: Review[] = [
//   {
//     name: 'Marie Dupont',
...
//   const [form, setForm] = useState<SubmitFields>({
//     name: '',
//     country: '',
//     course: '',
//     rating: 0,
...
//   const set = (k: keyof SubmitFields, v: string | number) =>
//     setForm((f) => ({ ...f, [k]: v }));
...
//   /* ── Firebase via useReviews ──
//      - reviews  : liste chargée depuis Firestore (fallback INITIAL_REVIEWS si vide/erreur)
//      - loading  : true pendant le fetch initial
//      - error    : message d'erreur éventuel (non-bloquant, l'UI reste visible)
//      - submitReview : envoie vers Firestore + optimistic UI
//   ── */
//   const { reviews, loading, error, submitReview } = useReviews(INITIAL_REVIEWS);
...
//                   <div
//                     key={i}
//                     className="w-2.5 h-2.5 rounded-full bg-[#8B5CF6] animate-bounce"
...
//                     </div>
//                   </div>
//                   <StarRating rating={reviews[current]?.rating ?? 0} />
//                 </div>
//                 <span className="inline-block px-3 py-1 rounded-full bg-[#EDE9FE] text-[#7C3AED] text-xs font-semibold mb-3">
//                   {reviews[current]?.course}
//                 </span>
...
//           {/* ── Navigation ── */}
//           {!loading && reviews.length > visible && (
//             <div className="flex justify-center items-center gap-4 mb-14">
//               <button
//                 onClick={prev}
//                 disabled={current === 0}
