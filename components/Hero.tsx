...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* ── Glows couleur logo ── */}
      <div className="absolute -top-40 -left-40 w-[520px] h-[520px] rounded-full bg-[#C4B5FD]/25 blur-3xl pointer-events-none" />
      <div className="absolute top-0 right-[-120px] w-[400px] h-[400px] rounded-full bg-[#F9A8D4]/20 blur-3xl pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <img
              ...
              className="relative z-10 w-[340px] h-[340px] object-cover rounded-full shadow-2xl shadow-purple-300/50 border-4 border-white"
            />
