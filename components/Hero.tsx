...
// /* ─────────────────────────────────────────────
//    Éléments du logo éparpillés en background :
//    étoiles, cœurs, livres, crayons, ampoules,
//    globes, lettres ABC, sparkles
// ───────────────────────────────────────────── */
// const BG_ELEMENTS = [
//   // ── Étoiles ★
...
//       {/* ── Glows couleur logo ── */}
//       <div className="absolute -top-40 -left-40 w-130 h-130 rounded-full bg-[#C4B5FD]/25 blur-3xl pointer-events-none" />
//       <div className="absolute top-0 right-[-120px] w-100 h-100 rounded-full bg-[#F9A8D4]/20 blur-3xl pointer-events-none" />
//       <div className="absolute bottom-[-150px] left-1/2 -translate-x-1/2 w-[440px] h-[440px] rounded-full bg-[#FDE68A]/18 blur-3xl pointer-events-none" />
...
//       {/* ── Cercle pointillés décoratif (reprise du cercle du logo) ── */}
//       <svg
//         className="absolute right-[-80px] top-1/2 -translate-y-1/2 w-[580px] h-[580px] opacity-[0.07] hidden lg:block pointer-events-none"
...
//       </svg>
//       <svg
//         className="absolute left-[-60px] top-1/4 w-[280px] h-[280px] opacity-[0.06] hidden md:block pointer-events-none"
...
//       {/* ══════════════════════════════════════════
//           ÉLÉMENTS DU LOGO — BACKGROUND ÉPARPILLÉ
//       ══════════════════════════════════════════ */}
...
//             {/* Anneaux tournants */}
//             <div
//               className="absolute w-[480px] h-[480px] rounded-full border-[3px] border-dashed border-[#C4B5FD]/40"
//               style={{ animation: 'spin 35s linear infinite' }}
//             />
//             <div
//               className="absolute w-[420px] h-[420px] rounded-full border-[2px] border-dashed border-[#F9A8D4]/30"
//               style={{ animation: 'spin 25s linear infinite reverse' }}
//             />

//             {/* Blob derrière le logo */}
...
//             {/* Étoiles orbitales (plus visibles) */}
//             {[
...
//             {/* Card : En ligne */}
//             <div
//               className="absolute -left-8 top-14 z-20 flex items-center gap-3 bg-white/95 backdrop-blur-sm rounded-2xl px-4 py-3 shadow-xl border border-[#EDE9FE]"
//               style={{ animation: 'float-bg 4s ease-in-out 0s infinite alternate' }}
//             >
...
//             {/* Card : Niveaux */}
//             <div
//               className="absolute -right-6 bottom-24 z-20 flex items-center gap-3 bg-white/95 backdrop-blur-sm rounded-2xl px-4 py-3 shadow-xl border border-[#EDE9FE]"
//               style={{ animation: 'float-bg 5s ease-in-out 2s infinite alternate' }}
//             >
...
//             {/* Badge ABC */}
//             <div
//               className="absolute left-8 bottom-8 z-20 flex items-center gap-2 text-white rounded-2xl px-4 py-2.5 shadow-lg shadow-purple-400/40"
//               style={{
//                 background: 'linear-gradient(135deg, #8B5CF6, #EC4899)',
//                 animation: 'float-bg 3.5s ease-in-out 1s infinite alternate',
//               }}
//             >
...
//             {/* Badge Fun ✏️ */}
//             <div
//               className="absolute right-4 top-16 z-20 flex items-center gap-1.5 bg-[#FEF9C3] border border-[#FDE68A] rounded-xl px-3 py-2 shadow-md"
//               style={{ animation: 'float-bg 4.5s ease-in-out 3s infinite alternate' }}
//             >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              {[
                ...
                <span key={i} className="absolute select-none" style={{ top: s.top, left: s.left, fontSize: s.size, color: s.color, opacity: 0.85, animation: `float-bg 3.5s ease-in-out ${s.delay} infinite alternate`, filter: 'drop-shadow(0 2px 6px currentColor)' }}>★</span>
              ))}

              <div className="relative z-10 w-85 h-85">
                <Image src="/Logo.jpeg" alt="English Sahla with Khawla" fill priority className="object-cover rounded-full shadow-2xl shadow-purple-300/50 border-4 border-white" />
              </div>
            ...
            <section className="relative overflow-hidden bg-[#f7f3ed]">
              ...
              <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                ...
                <div className="text-center mb-14">
                  {/* <p className="text-xs font-semibold tracking-[0.15em] uppercase text-[#7C3AED] mb-2">By the numbers</p> */}
                  <h2 className="text-3xl md:text-4xl font-extrabold text-gray-800" style={{ fontFamily: "'Nunito', sans-serif" }}>
                    Results that{' '}
                    <span className="bg-linear-to-r from-[#8B5CF6] to-[#EC4899] bg-clip-text text-transparent">speak for themselves</span>
                  </h2>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                  {facts.map((fact, i) => (
                    ...
                    >
                      ...
                      <div className="text-gray-500 text-xs font-medium leading-tight">{fact.label}</div>
                    </div>
                  ))}
                </div>
              </div>
