...
//   // Courses
//   export const courses: Translations = {
...
import { Translations } from "../types";
  ...
  'courses.levelOneToOne': { en: 'Personalized', ar: 'مخصص' },
  'courses.levelDiscussion': { en: 'Conversation', ar: 'محادثة' },

  'courses.oneToOne.title': { en: 'One to One', ar: 'دروس فردية' },
  'courses.oneToOne.desc': {
  ...
  'courses.discussion.desc': {
    en: 'Live conversation sessions in English to build fluency, confidence, and natural pronunciation.',
    ar: 'جلسات محادثة مباشرة باللغة الإنجليزية لتطوير الطلاقة والثقة والنطق الطبيعي.',
  },
};